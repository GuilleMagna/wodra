jQuery(document).ready(function($) {
    ...
    const html = '<button class="btn-sus btn-outline-white mt-1 mt-lg-4" type="submit">' +
                    '<span class="text-btn-01">Suscribirme al news</span>' +
    ...
    $('.wpcf7-submit.submit_newsletter').replaceWith(html);
