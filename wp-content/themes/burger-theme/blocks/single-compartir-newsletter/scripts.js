jQuery(document).ready(function($) {
    ...
    const html = '<button class="btn btn-outline-primary px-3" type="submit">' +
                    '<span class="text-btn-01 mx-3 text-white">SUSCRIBIRME AL NEWS</span>' +
    ...
    $('#form-newsletter-single .wpcf7-submit.submit_newsletter').replaceWith(html);
